...
const select1Check = document.querySelector('#select-1');
if (select1Check) {
	const select1 = new CustomSelect('#select-1');
}
const select2Check = document.querySelector('#select-2');
if (select2Check) {
...
const select6Check = document.querySelector('#select-6');
if (select6Check) {
	const select6 = new CustomSelect('#select-6');
}

const select7Check = document.querySelector('#select-7');
if (select7Check) {
